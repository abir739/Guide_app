...
import 'package:guide_app/Test/modele/creatorUser.dart';
import 'package:guide_app/Test/modele/touristGroup.dart';
import 'package:guide_app/Test/modele/updaterUser.dart';
 ...
 UpdaterUser? updaterUser;
  PlanningMainModel({
    ...
    this.touristGroupId,
     ...
     this.agency,
     this.touristGuide,
     this.touristGroup, this.creatorUser,
       this.updaterUser
  });
